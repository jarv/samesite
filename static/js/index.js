...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  // node_modules/@alpine-collective/toolkit-interval/dist/module.cjs.js
  var require_module_cjs2 = __commonJS({
    "node_modules/@alpine-collective/toolkit-interval/dist/module.cjs.js"(exports) {
      var __defProp = Object.defineProperty;
  ...
  var require_js_cookie = __commonJS({
    "node_modules/js-cookie/dist/js.cookie.js"(exports, module) {
      (function(global2, factory) {
        typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, function() {
          var current = global2.Cookies;
          var exports2 = global2.Cookies = factory();
          exports2.noConflict = function() {
            global2.Cookies = current;
            return exports2;
          };
        }());
      })(exports, function() {
  ...
  var require_dist = __commonJS({
    "dist/index.js"(exports) {
      ...
      var alpinejs_1 = __importDefault(require_module_cjs());
      var toolkit_interval_1 = __importDefault(require_module_cjs2());
      var js_cookie_1 = __importDefault(require_js_cookie());
      window.Alpine = alpinejs_1.default;
      window.Cookies = js_cookie_1.default;
      window.Alpine.data("cookie", function() {
        return {
          cookies: [],
          isSecureFalse: false,
          isSecureTrue: true,
          ...
          cookieEmoji: function(name) {
            return this.hasCookie(name) ? "\u{1F36A}" : "";
          },
          ...
          deleteCookies: function() {
            Object.getOwnPropertyNames(js_cookie_1.default.get()).forEach(function(c) {
              ...
              try {
                ...
                console.error("Error parsing cookie value as json", c, error2);
              }
            });
          },
          ajaxGET: function() {
          ...
          updateWithContent: function(url, className, method, isSecureFalse) {
            ...
            fetch(url, options).then(function(response) {
              ...
              console.error("Error updating elements: ".concat(error2.message));
            });
          }
        };
      });
